...
for (let i = 0; i < playlistData.length; i++) {
  let card = printDiv(playlistData[i]);
...
playlistcard.forEach(function (card) {
  card.addEventListener("click", function () {
    ...
    title.innerText = videoPlaySectionData[card.id - 1]["title"];

    // for discription
    let discription = document.querySelector("#video-description");
    discription.innerText = videoPlaySectionData[card.id - 1]["description"];
    // for grabing yellow border
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // for title
  let title = document.querySelector("#video-title");
  title.innerText = videoPlaySectionData[0]["title"];

  // for discription
  let discription = document.querySelector("#video-description");
  discription.innerText = videoPlaySectionData[0]["description"];
